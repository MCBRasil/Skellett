...
@Syntax("[the] [(skellett[ ][(cord|proxy)]|bungee[ ][cord])] online [status] of (skellett[ ][(cord|proxy)]|bungee[ ][cord]) server %string%")
...
public class ExprBungeeServerOnline extends SimpleExpression<Boolean>{
	...
	public String toString(@Nullable Event e, boolean arg1) {
		return "[the] [(skellett[ ][(cord|proxy)]|bungee[ ][cord])] online [status] of (skellett[ ][(cord|proxy)]|bungee[ ][cord]) server %string%";
	}
	@Override
	@Nullable
